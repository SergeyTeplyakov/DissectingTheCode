...
namespace System.Runtime.CompilerServices.Ex
{
    ...
    public struct ValueTaskAwaiter<TResult> : ICriticalNotifyCompletion
    {
        ...
        private readonly System.Threading.Tasks.Ex.ValueTask<TResult> _value;

        /// <summary>Initializes the awaiter.</summary>
        /// <param name="value">The value to be awaited.</param>
        internal ValueTaskAwaiter(System.Threading.Tasks.Ex.ValueTask<TResult> value) => _value = value;
